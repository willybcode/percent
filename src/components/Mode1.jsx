...
function Mode1() {
    ...
    return (
        <div
            className='bg-gray-900/70  hover:bg-sky-900/70 hover:ring-2 transition-all duration-1000 rounded-xl relative h-52 w-80 p-3 text-slate-100 font-semibold ml-5 mt-5 overflow-hidden'>
            ...
            <div className='flex flex-col h-5/6 mt-6 justify-between'>
                ...
                <span className='flex md:space-x-2 items-center space-x-1 md:items-start   mb-5 mt-2'>
