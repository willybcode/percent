...
function Mode6() {
    ...
    return (
        <div
            ...
            <div
                className={`  absolute inset-0 text-white ${ !tip && ' translate-x-96 '}  transition-all duration-1000 hover:bg-slate-950  bg-slate-600 p-3  flex justify-center    rounded-xl `}>
            ...
            <div className='flex flex-col h-5/6 mt-6 justify-between'>
                ...
                <span className='flex  space-x-4 items-center justify-center mb-5 mt-2'>
